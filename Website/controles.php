...
<body>
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="#"><i class="fa fa-fw fa-table"></i> Log Out</a>
                        </li>
                    </ul>
                </li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-fw fa-bar-chart-o"></i> Controles
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i>Controles</h3>
                            </div>
                            <div class="panel-body">
                                <div id="morris-area-cont"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="js/plugins/morris/morris-data-cont.js"></script>
