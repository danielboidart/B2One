        ...
        try 
            {
                $bdd = new PDO('mysql:host=localhost;dbname=btwoone','root','',array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION ));
                    ...
                    $requete = $bdd->prepare("SELECT valeur_hall FROM hall ORDER BY id_hall DESC LIMIT 10");
                    $requete->execute();
                    $resultat = $requete->fetchAll();

                    $bde = new PDO('mysql:host=localhost;dbname=btwoone','root','',array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION ));

                    $temp = $bde->prepare("SELECT date_hall FROM hall ORDER BY id_hall DESC LIMIT 10");
                    $temp->execute();
                    ...
                    $heure = $bde->prepare("SELECT heure_hall FROM hall ORDER BY id_hall DESC LIMIT 10");
                    $heure->execute();
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-fw fa-bar-chart-o"></i> Hall
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i>Graphique Hall</h3>
                            </div>
                            <div class="panel-body">
                                <div id="morris-area-hall"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Tableau Hall</h3>
                            </div>
                            <div class="panel-body">
...
$(function () {
    ...
    var hall1 = '<?PHP echo $resultat[0][0];?>';
    var hall2 = '<?PHP echo $resultat[1][0];?>';
    var hall3 = '<?PHP echo $resultat[2][0];?>';
    var hall4 = '<?PHP echo $resultat[3][0];?>';
    var hall5 = '<?PHP echo $resultat[4][0];?>';
    var hall6 = '<?PHP echo $resultat[5][0];?>';    
    ...
    new Morris.Line({
        ...
        xkey: 'period',
        ykeys: ['Hallmax','Hall','Hallmin'],
        labels: ['Hallmax','Hall','Hallmin'],
        xLabels: ['minutes'],
        pointSize: 2,
