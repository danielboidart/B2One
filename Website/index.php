        ...
        try 
            {
                $bdd = new PDO('mysql:host=localhost;dbname=btwoone','root','',array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION ));
                    ...
                    $requete = $bdd->prepare("SELECT celsius_temperature FROM temperature ORDER BY id_temperature DESC LIMIT 10");
                    $requete->execute();
                    $resultat = $requete->fetchAll();

                    $bde = new PDO('mysql:host=localhost;dbname=btwoone','root','',array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION ));

                    $temp = $bde->prepare("SELECT date_temperature FROM temperature ORDER BY id_temperature DESC LIMIT 10");
                    $temp->execute();
                    ...
                    $heure = $bde->prepare("SELECT heure_temperature FROM temperature ORDER BY id_temperature DESC LIMIT 10");
                    $heure->execute();
            ...
            <!--
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-fw fa-bar-chart-o"></i> Temprature
                            </li>
                        </ol>
                    </div>
                </div> 
            -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Graphique Température </h3>
                            </div>
                            <div class="panel-body">
                                <div id="morris-area-temp"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class=""></i> Tableau Température</h3>
                            </div>
                            <div class="panel-body">
...
$(function () {
    ...
    var temperature1 = '<?PHP echo $resultat[0][0];?>';
    var temperature2 = '<?PHP echo $resultat[1][0];?>';
    var temperature3 = '<?PHP echo $resultat[2][0];?>';
    var temperature4 = '<?PHP echo $resultat[3][0];?>';
    var temperature5 = '<?PHP echo $resultat[4][0];?>';
    var temperature6 = '<?PHP echo $resultat[5][0];?>';
    ...
    // Area Chart
     Morris.Line({
        ...
        xkey: 'period',
        ykeys: ['Tempmax','Temperature','Tempmin'],
        labels: ['Tempmax', 'Temperature', 'Tempmin'],
        xLabels: ['minutes'],
        pointSize: 2,
